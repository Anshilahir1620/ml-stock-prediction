    ...
    return (
        <div ref={containerRef} className="w-full pt-32 pb-48 px-6 md:px-24 bg-[#fbfbf9] overflow-x-hidden relative min-h-screen">
            ...
            <div className="max-w-4xl mb-16 md:mb-32 reveal-block">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-[95px] font-black text-gray-900 mb-6 md:mb-10 tracking-tighter leading-[1] md:leading-[0.95]">
                    Synthesizing <br /> <span className="text-gray-400 italic">Market Truth.</span>
                </h1>
                <p className="text-[16px] md:text-[20px] text-gray-500 font-bold leading-relaxed uppercase tracking-tighter">
                    We bridge the gap between institutional-grade quantitative analysis and the modern retail terminal through precision logic.
                </p>
            </div>
                ...
                <div className="flex flex-col md:flex-row gap-10 md:gap-20 items-start">
                    <div className="w-full md:w-1/3">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <h2 className="text-[12px] md:text-[14px] font-black text-gray-900 uppercase tracking-[0.4em]">About the Project</h2>
                        </div>
                        <h3 className="text-2xl md:text-3xl font-black tracking-tighter text-gray-900 uppercase italic">Purpose & <br /> <span className="text-gray-300 tracking-normal">Inspiration.</span></h3>
                    </div>
                    <div className="w-full md:w-2/3 space-y-6 md:space-y-8">
                        <p className="text-[16px] md:text-[18px] text-gray-500 leading-relaxed font-bold uppercase tracking-tight">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 mb-24 md:mb-48 reveal-block">
                <div className="space-y-8 md:space-y-12">
                    <div className="p-8 md:p-12 bg-white border border-gray-100 rounded-[2.5rem] md:rounded-[3.5rem] shadow-xl shadow-gray-200/50 relative overflow-hidden group">
                        ...
                        <h3 className="text-[12px] md:text-[14px] font-black text-gray-900 uppercase tracking-[0.4em] mb-6 md:mb-8 flex items-center gap-3">
                            <Code2 size={20} className="text-emerald-500" />
                            Engineering DNA
                        </h3>
                        <p className="text-[14px] md:text-[16px] text-gray-500 leading-relaxed font-bold uppercase tracking-tighter">
                    ...
                    <div className="pl-8 md:pl-12 border-l-4 border-emerald-500">
                        <h4 className="text-[10px] md:text-[12px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4 md:mb-6">Execution Goal</h4>
                        <p className="text-[28px] md:text-[44px] text-gray-900 font-black leading-[1] md:leading-[0.9] tracking-tighter uppercase italic">
                            "To synthesize noise into <span className="text-emerald-500">actionable</span> quantitative signals."
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-8 md:space-y-10">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <h3 className="text-[16px] md:text-[18px] font-black text-gray-900 uppercase tracking-[0.5em]">The Stack</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                        {techStack.map((tech) => (
                            <div key={tech.name} className="flex items-center gap-4 p-6 md:p-8 bg-white border border-gray-100 rounded-2xl md:rounded-3xl hover:border-gray-900 transition-all duration-500 group cursor-default">
                                <div className="p-2.5 md:p-3 bg-gray-50 rounded-xl group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                                    {tech.icon}
                                </div>
                                <span className="text-[11px] md:text-[13px] font-black text-gray-900 uppercase tracking-widest">{tech.name}</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="developer-section w-full bg-gradient-to-br from-gray-900 via-[#062419] to-black rounded-[3rem] md:rounded-[4rem] p-10 md:p-32 text-center text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    <div className="developer-icon w-20 h-20 md:w-24 md:h-24 bg-emerald-500 rounded-[2rem] md:rounded-[2.5rem] flex items-center justify-center mb-8 md:mb-10 shadow-[0_0_80px_rgba(16,185,129,0.5)]">
                        <Users size={32} className="text-white" />
                    </div>

                    <div className="overflow-hidden mb-4 md:mb-6">
                        <span className="developer-split-right text-emerald-400 font-black text-[12px] md:text-[14px] uppercase tracking-[0.4em] md:tracking-[0.8em] block">Lead Architect</span>
                    </div>

                    <h2 className="text-3xl sm:text-4xl md:text-[100px] font-black mb-10 md:mb-12 tracking-tighter leading-tight italic flex flex-wrap justify-center gap-x-4 md:gap-x-8">
                        <span className="developer-split-left inline-block">Hi, I’m</span>
                        <span className="developer-split-left text-emerald-400 inline-block px-1">Anshil</span>
                        <span className="developer-split-right inline-block">Chotara.</span>
                    </h2>

                    <div className="flex flex-col sm:flex-row gap-4 md:gap-8 mt-4 md:mt-6 w-full sm:w-auto px-4 sm:px-0">
                        <a
                            href="https://www.linkedin.com/in/anshil-chotara"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full sm:w-auto px-8 md:px-12 py-5 md:py-6 bg-white text-gray-900 font-black rounded-2xl flex items-center justify-center gap-4 transition-all hover:scale-105 active:scale-95 group text-[13px] md:text-[15px] uppercase tracking-[0.2em] shadow-xl"
                        >
                        ...
                        <a
                            ...
                            className="w-full sm:w-auto px-8 md:px-12 py-5 md:py-6 bg-transparent border-2 border-white/20 hover:border-emerald-500 hover:text-emerald-500 text-white font-black rounded-2xl flex items-center justify-center gap-4 transition-all hover:scale-105 active:scale-95 group text-[13px] md:text-[15px] uppercase tracking-[0.2em] shadow-xl"
                        >
                            <Mail size={20} />
                            Email
                        </a>
